...
/**
 * {@code TakeAShower} is [desc]
 * <p>
 * [descSuite]
 *
 * @author Joël CANCELA VAZ
 */
public class TakeAShower extends JeuDevint {
        ...
        chronoActivity = new ChronoActivity(titre(), new MultiChoiceList<>(Arrays.asList(answers)));*/
            ...
            chronoActivity = (ChronoActivity) gson.fromJson(new InputStreamReader(getClass().getResourceAsStream("/activity/wash.json")), ChronoActivity.class);
